...
// MFC_Cursach.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Professor_timetableApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CMFC_CursachApp

Professor_timetableApp::Professor_timetableApp()
{
...
// Единственный объект CMFC_CursachApp

Professor_timetableApp theApp;


// инициализация CMFC_CursachApp

BOOL Professor_timetableApp::InitInstance()
{
	...
	if (nResponse == IDOK)
	{
		...
		pApp->PutDisplayAlerts(0, true);//отключить уведомления
		pApp->Quit();
